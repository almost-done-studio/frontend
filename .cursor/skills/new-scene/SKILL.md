---
name: new-scene
description: Create a new Phaser scene from template. Use when user runs /new-scene or asks to scaffold a scene.
...
Prefer delegating to the `scene-builder` subagent for the full implementation.
