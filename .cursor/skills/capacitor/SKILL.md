---
name: capacitor
description: Capacitor Android/iOS native build patterns. Apply when adding native shells, syncing web build to platforms, or debugging device builds. Use when user runs /capacitor or asks about native builds.
disable-model-invocation: true
---

# /capacitor

Capacitor Android/iOS native shell for AlmostDoneStudio.
